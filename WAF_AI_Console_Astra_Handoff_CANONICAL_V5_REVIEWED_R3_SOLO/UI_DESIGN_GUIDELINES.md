# WAF AI Console — UI Design Guidelines V5 REVIEWED R3 — Solo Operations
...
```text
Dataset / Published Revision / Working Changes
...
- comparable point 2개 미만이면 빈 차트 대신 Current Official Evaluation summary를 보여주고 비교 기준 변경 메시지를 표시
