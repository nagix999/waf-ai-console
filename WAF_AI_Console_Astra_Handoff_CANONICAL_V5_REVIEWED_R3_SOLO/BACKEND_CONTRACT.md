# WAF AI Console — Backend / Data Contract V5 REVIEWED R3 SOLO
...
- latest Published Revision의 해당 case snapshot으로 Working Draft를 복구
- published snapshot이 없거나 해당 case가 없으면 명확한 404/409
- `expected_working_revision`으로 stale edit 차단
