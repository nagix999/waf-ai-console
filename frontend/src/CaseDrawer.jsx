...
export default function CaseDrawer({ id, onClose, onOpen }) {
  ...
  return <Dialog open={Boolean(id)} title={w("문항 결과", "Case result")} className="r3-case-drawer" onClose={onClose}>
    <div className="ux-toolbar"><button className="text-button" onClick={() => onOpen(id)}>{w("전체 분석 상세", "Open full analysis")} ↗</button></div>
