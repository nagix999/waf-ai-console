...
export default function ProductionApi() {
  ...
  return <div className="page-stack api-document-page">
    ...
    {reference && <div className="api-source-note">입력 스키마 v{reference.input_schema.version_number}<a href="#connect/input-schema">스키마 보기 →</a><button type="button" className="text-button" onClick={() => setTechnical(true)}>기술정보</button></div>}
