...
export const metricHelp = {
  ...
  agreement: "기준 판정 일치율 = 참고 답안과 같은 최종 판정 수 / 비교 가능한 실제 완료 분석 수. 기대 답안이 보류인 문항도 포함합니다. 높을수록 해당 참고값과 많이 일치하지만 합성 기대값·AI를 보고 작성한 답안과의 일치는 독립적인 운영 정확도가 아닙니다. 낮으면 답안 품질과 분석 결과를 함께 검토하세요.",
};
